...
- ♻️ **飞书交互下线** — 删除飞书 Webhook、消息卡片、进度推送、路由兼容层、部署配置及部署指南，保留通用 Chat 服务与 WhatsApp 网关。
...
- ✨ **飞书退休契约** — 增加生产模块、Blueprint 注册、旧 Webhook 404、部署配置与文档防回流检查，并约束 Chat 与 WhatsApp 边界继续保留。
