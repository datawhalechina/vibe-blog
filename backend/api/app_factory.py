...
def init_services(app):
    ...
    from services.publishing import init_oss_service, get_oss_service
    from services.media import init_video_service, get_video_service
    from services.database_service import init_db_service
    from services.documents import init_file_parser, init_knowledge_service
    from api.routes.blog_routes import init_blog_services
    ...
    try:
        ...
        from api.routes.queue_routes import init_queue_routes
        from api.routes.scheduler_routes import init_scheduler_routes
    ...
    try:
        ...
        from api.routes.chat_routes import init_chat_service
